...
class Auth {
  ...
  static deauthenticateUser() {
    ...
    localStorage.removeItem(STORAGEKEY.patientName);
  }
  ...
  /**
   * Save User credentials Chat Message Id To Local Storage
   *
   * @param {string} id
   */
  static setUserChatMessageId(id) {
    localStorage.setItem(STORAGEKEY.chatMessage, id);
  }

  /**
   * Get User Chat Message Id
   *
   * @returns {string}
   */
  static getUserChatMessageId() {
    return localStorage.getItem(STORAGEKEY.chatMessage);
  }
